...
import ShareButton from "../../../shared/components/ShareButton.js";
import ZoomImage from "../../../shared/components/ZoomImage.js";
import smoothScrollTop from "../../../shared/functions/smoothScrollTop.js";

// this file is responsible for the page you see after clicking any of the blog post
                ...
                <Grid container spacing={5}>
                    <Grid item md={9}>
                        <Card className={classes.card}>
                            {/* the box responsible for the header of an article */}
                    ...
                    <Grid item md={3}>
                        ...
                        {/* the articles on the right side of the page */}
